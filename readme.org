...
Original git repo for GAM adjusted age modeling in [[https://pmc.ncbi.nlm.nih.gov/articles/PMC12747136/][Perica, Maria I et al. “Development of frontal GABA and glutamate supports excitation/inhibition balance from adolescence into adulthood.” Progress in neurobiology vol. 219 (2022): 102370. doi:10.1016/j.pneurobio.2022.102370]].

Now also hosting general GAM adjusted MRSI for the PFC slice (~adjust_all.R~). See [[https://pubmed.ncbi.nlm.nih.gov/42575941/][Pupi, Michael et al. “7T magnetic resonance spectroscopic imaging of subcortical neurometabolites across antipsychotic treatment in acutely symptomatic early-phase schizophrenia spectrum disorders.” Neuropsychopharmacology : official publication of the American College of Neuropsychopharmacology, 10.1038/s41386-026-02522-y]]
...
* Gotchas
  ...
  * ~dateNumeric~ used to model and saved in ~mgcv-gam_tibble.Rdata~ are from ~as.numeric(as.POSIXct())~
...
#+end_src
  * ~mgcv-gam_tibble.Rdata~ has mgcv GAM models for BST3 7T scanner date correction generated with original Luna dataset, applied to the Sarpal clinical cohort.
